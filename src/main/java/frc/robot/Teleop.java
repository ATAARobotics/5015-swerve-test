...
public class Teleop {
    ...
    public void teleopPeriodic() {
        ...
        swerveDrive.periodic(new SwerveCommand(joysticks.getXVelocity() * RobotMap.MAXIMUM_SPEED, joysticks.getYVelocity() * RobotMap.MAXIMUM_SPEED, joysticks.getRVelocity() * RobotMap.MAXIMUM_ROTATIONAL_SPEED));
    }
}
