...
public class Teleop {
    ...
    public void teleopPeriodic() {
        ...
        SmartDashboard.putNumber("Front Left Distance", encoders.getModuleDistance(0));
        SmartDashboard.putNumber("Front Right Distance", encoders.getModuleDistance(1));
        SmartDashboard.putNumber("Rear Left Distance", encoders.getModuleDistance(2));
        SmartDashboard.putNumber("Rear Right Distance", encoders.getModuleDistance(3));
